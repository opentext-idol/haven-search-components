...
@JsonDeserialize(builder = IdolQueryRestrictions.IdolQueryRestrictionsBuilder.class)
public class IdolQueryRestrictions implements QueryRestrictions<String> {
    ...
    public static class IdolQueryRestrictionsBuilder implements QueryRestrictions.QueryRestrictionsBuilder<IdolQueryRestrictions, String> {
    }
}
