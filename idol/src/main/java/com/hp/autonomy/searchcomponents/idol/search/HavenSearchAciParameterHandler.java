...
public interface HavenSearchAciParameterHandler {
    ...
    void addGetDocumentOutputParameters(final AciParameters aciParameters, final GetContentRequestIndex<String> indexAndReferences, final String securityInfo);
