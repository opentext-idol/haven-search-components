...
public class IdolSuggestRequestTest extends SuggestRequestTest<String> {
    @Override
    @Before
    public void setUp() {
        super.setUp();
    ...
    @Override
    protected SuggestRequest<String> constructObject() {
        return SuggestRequest.<String>builder()
                .reference("REFERENCE")
