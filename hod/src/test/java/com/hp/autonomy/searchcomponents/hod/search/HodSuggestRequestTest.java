...
public class HodSuggestRequestTest extends SuggestRequestTest<ResourceIdentifier> {
    @Override
    @Before
    public void setUp() {
        super.setUp();
    ...
    @Override
    protected SuggestRequest<ResourceIdentifier> constructObject() {
        return SuggestRequest.<ResourceIdentifier>builder()
                .reference("REFERENCE")
