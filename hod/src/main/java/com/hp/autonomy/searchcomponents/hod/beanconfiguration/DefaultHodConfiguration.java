...
class DefaultHodConfiguration {
    ...
    public DatabasesService<Database, HodDatabasesRequest, HodErrorException> databasesService(final ResourcesService resourcesService, final AuthenticationInformationRetriever<HodAuthenticationPrincipal> authenticationInformationRetriever) {
